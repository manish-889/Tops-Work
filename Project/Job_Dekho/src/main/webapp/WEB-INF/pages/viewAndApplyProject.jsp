...
<c:forEach items="${projectData }" var="e">
 <div class="container">
        <div class="job-details">
           <h1 class=>${e.projectt }</h1>
           <h3>${e.cemail }</h3>
	       <p style="font-size:18px;">${e.projectd }</p>
...
"./files/webimages/${ef.projectf}"
     ...
     <div class="form-popup" id="applyForm">
       <form id="projectApplicationForm" action="/Job_Dekho/applyForProject" method="post" enctype="multipart/form-data" class="form-container">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-6">
				<div class="form-group fl_icon">
					...
					<input class="form-input" type="text" value="${e.cname }" readonly>
				</div>
			</div>
			<div class="col-xs-12 col-sm-6 fl_icon">
				<div class="form-group fl_icon">
					...
					<input class="form-input" type="text" placeholder="Your email" value="${e.projects }" readonly >
				</div>
			</div>
