  ...
  <body>
    ...
    <div class="colums">
        ...
        <div class="item">
            ...
            <h6>Suggested skills: Java, Spring, MySQL, Web Hosting, Software Testing, Software Architecture</h6>
        </div>
        <br><br>
        <div class="question">
        ...
        <c:forEach items="${CompanyKey}" var="e">
            ...
            <input type="hidden" name="cname" value="${e.name}" readonly />
           
            <input type="hidden" name="cemail" value="${e.email}" readonly />
        </c:forEach>
        <br>
        <h4>${message}</h4>
