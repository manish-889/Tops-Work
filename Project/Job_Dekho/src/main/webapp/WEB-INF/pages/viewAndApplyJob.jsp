...
<c:forEach items="${jobData }" var="e"> 
 <div class="container">
    ...
    <div class="form-popup" id="applyForm">
      <form id="jobApplicationForm" action="/Job_Dekho/applyForJob" method="post" enctype="multipart/form-data" class="form-container">
    ...
    <input type="text" id="position" placeholder="Enter Your Position" value="${e.title }" name="position" required readonly>

	<c:forEach items="${freelancerDetails }" var="ef">
        ...
        <input type="hidden" placeholder="Enter Your ID" value="${ef.id}" name="id">
	</c:forEach>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-6">
				<div class="form-group fl_icon">
					...
					<input class="form-input" type="text" value="${e.title }" readonly>
				</div>
			</div>
			<div class="col-xs-12 col-sm-6 fl_icon">
				<div class="form-group fl_icon">
					...
					<input class="form-input" type="text" placeholder="Your email" value="${e.skills }" readonly >
				</div>
			</div>
			<div class="col-xs-12">									
				<div class="form-group">
				<label><h2>Job Discription</h2></label>
					<p class="form-input">${e.discription }</p>
				</div>
			</div>
