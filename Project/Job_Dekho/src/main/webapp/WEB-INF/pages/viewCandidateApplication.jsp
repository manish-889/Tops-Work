...
<br>
 ...
 <c:forEach items="${CompanyKey }" var="m">
 <div class="button-container">
        <a href="/Job_Dekho/acceptedJobApplication/${m.name}"><button class="btn accepted" style="color:#fff;">Accepted Applications &nbsp;<i class="fa-solid fa-clipboard-check"></i></button></a>
        <a href="/Job_Dekho/rejectedJobApplication/${m.name}"><button class="btn rejected" style="color:#fff;">Rejected Applications &nbsp; <i class="fa-regular fa-circle-xmark"></i></button></a>
 </div></c:forEach>
...
<table>
    ...
    <tbody>
      		<c:forEach items="${allCandidateData}" var="e">
            <tr>
                ...
                <embed class="pdf" 
               src=
"/Job_Dekho/files/webimages/${e.fresume}"
            width="210" height="250">
            
             <a href="/Job_Dekho/files/webimages/${e.fresume}" class="download-button" download="ProjectPlus Resume.PDF" style="background-color:#457b9d;padding:5px; color:#fff;">Download Resume
    ...
    <i class="fa-solid fa-file-arrow-down"></i>
                ...
                <td> 
                 <form action="/Job_Dekho/updateJobStatus" method="post">
...
<table>
    ...
    <tbody>
      	<c:forEach items="${allProejctData }" var="ef">
            <tr>
        ...
        <embed class="pdf" 
               src=
"/Job_Dekho/files/webimages/${ef.resumef}"
            width="250" height="250">
            
            
             <a href="/Job_Dekho/files/webimages/${ef.resumef}" class="download-button" download="ProjectPlus Resume.PDF" style="background-color:#457b9d;padding:5px; color:#fff;">Download Resume
    ...
    <i class="fa-solid fa-file-arrow-down"></i>
                ...
                <td> 
                 <form action="/Job_Dekho/updateProjectStatus" method="post">
