...
<body>
	...
	<section class="container">
		...
		<nav class="navbar navbar-expand-lg custom_nav-container">
			<a class="/" href="/SpringMVCPersonal_Project"> <img
				src="./files/images/logo.png" alt="" /> <span> ProjectPulse
			</span>
			</a>


		</nav>
		<header>Hire the best freelancers for any job, online.
			Registration Here</header>
		<form id="registrationForm" action="registerCompanyData" class="form"
			method="post" enctype="multipart/form-data">
			<div class="input-box">
				<label>Personal Name/Organization Name</label> <input type="text"
			...
			<div class="input-box">
				<label>Phone Number</label> <input type="tel"
					placeholder="Enter Contact number" name="number" required
					pattern="\d{10}" title="Phone number should be 10 digits." />
			</div>

			<div class="input-box">
				<label>Company Website</label> <input type="url"
			...
			<div class="input-box">
				<label>Company Photo or Banner</label> <input type="file"
					name="filename" required accept="image/*"
