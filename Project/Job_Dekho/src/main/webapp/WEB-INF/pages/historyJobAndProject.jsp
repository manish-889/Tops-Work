...
<br>
<br>
   <h2>Manage Jobs &nbsp; <i class="fa-solid fa-user-check"></i></h2>
<table>
    ...
    <tbody>
        <c:forEach items="${historyJobData}" var="e">
            <tr>
                ...
                <td data-label="Date">
                 <a href="/Job_Dekho/editJobDetails/${e.id }">Edit &nbsp;<i class="fa-regular fa-pen-to-square"></i></a>
                 <br>
                 <br>
                 <br>
                 <a href="/Job_Dekho/removeJob/${e.id}">Remove &nbsp;  <i class="fa-solid fa-user-xmark"></i></a>
...
<h2>Manage Project &nbsp;<i class="fa-solid fa-briefcase"></i></h2>
<table>
    ...
    <tbody>
        <c:forEach items="${historyProjectData}" var="ef">
            <tr>
                <td data-label="Farmer Name">${ef.projectt}</td>
                <td data-label="Product">${ef.projectb}</td>
                <td data-label="Type">${ef.projects}</td>
                <td data-label="Date">${ef.cname}</td>
                <td data-label="Date">${ef.cemail}</td>
                <td data-label="Price">
                
                  
        <embed class="pdf" 
               src=
"/Job_Dekho/files/webimages/${ef.projectpdf}"
            width="250" height="250">
                 ...
                 <br>
                 <br>
                 <a href="/Job_Dekho/removeProject/${ef.id}">Remove &nbsp;  <i class="fa-solid fa-user-xmark"></i></a>
