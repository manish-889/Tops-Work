...
<table>
    ...
    <tbody>
     <c:forEach items="${myApplicationList }" var="e">
            <tr>
                <td data-label="Farmer Name">${e.cname}</td>
                <td data-label="Product">${e.position}</td>
                <td data-label="Type">${e.fname}</td>
                <td data-label="Price">${e.femail}</td>
                <td data-label="Date">${e.fresume}
...
<table>
    ...
    <tbody>
    	<c:forEach items="${getProjectList}" var="ef">
                    <tr>
                <td data-label="Farmer Name">${ef.cname}</td>
                <td data-label="Product">${ef.projectt}</td>
                <td data-label="Type">${ef.fname}</td>
                <td data-label="Price">${ef.femail}</td>
                <td data-label="Date">${ef.resumef}</td>
