...
<div class="content">
     <c:forEach items="${getFreelancers }" var="e">
        <div class="card-box">
            <div class="text-center">
                <div class="thumb-lg member-thumb mx-auto">
                    <img src="./files/webimages/${e.profilef}" class="rounded-circle img-thumbnail" alt="profile-image">
                </div>
              ...
              <a href="${e.linkedin}" title="LinkedIn" class="btn btn-linkedin btn-lg" style="background-color:#3a86ff;""><i class="fa fa-linkedin fa-fw"></i> LinkedIn</a>
              <br>
