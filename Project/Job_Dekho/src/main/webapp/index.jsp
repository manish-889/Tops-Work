        ...
        <nav class="navbar navbar-expand-lg custom_nav-container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="loginFreelancer">Login As Freelancer &nbsp; <i class="fa-solid fa-users"></i></a>
              </li>
            </ul>
        ...
        <div class="info_main">
          <div class="row">
            ...
            <div class="col-md-3 col-lg-2 offset-lg-1">
              ...
              <p>
               <a href="https://www.linkedin.com/in/manish-giri-615382285">Manish Giri</a>
              </p>
            </div>
  ...
  <footer class="container-fluid footer_section ">
    <div class="container">
      <p>
        ...
        <a href="https://html.design/">Manish Giri</a>
      </p>
    </div>
  </footer>
  <!-- end  footer section -->
