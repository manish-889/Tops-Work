											...
											<tbody>
												<c:forEach items="${categories}" var="e">
													<tr>
														...
														<td><a href="delete?cid=${e.getCategoryId()}" class="btn btn-danger">Delete</a></td>
														<td><a href="edit?cid=${e.getCategoryId()}" class="btn btn-primary">Update</a></td>
													</tr>
												</c:forEach>
