				...
				<div class="catagories-menu">
					<ul>
						<c:forEach items="${categories}" var="e">
							<li class="active"><a href="getProduct?id=${e.getCategoryId()}">${e.getCategoryName()}</a></li>
						</c:forEach>
					</ul>
				</div>
			</div>
						...
						<div class="col-12 col-sm-6 col-md-12 col-xl-6">
							<div class="single-product-wrapper">
								...
								<div class="product-img">
									<a href="productDetails?pid=${dt.getProductId()}"><img src="./Img/${dt.getImageName()}" alt=""></a>
								...
								<div
									...
									<div class="product-meta-data">
										<div class="line"></div>
										<p class="product-price">₹ ${dt.getPrice()}</p>
										<a href="productDetails?pid=${dt.getProductId()}">
											<h6>${dt.getProductName()}</h6>
										</a>
									</div>
									<!-- Ratings & Cart -->
