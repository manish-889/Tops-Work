							...
							<div class="card">
								<div class="card-body">
									...
									<form class="forms-sample" action="addProduct" method="post"
										...
										<div class="form-group">
											<label for="category">Category</label> <select
												...
												<c:forEach items="${categories}" var="e">
													<option value="${e.getCategoryId()}">${e.getCategoryName()}</option>
												</c:forEach>
										...
										<div class="form-group">
											<label for="imageName">File upload</label> <input type="file"
											...
											<tbody>
												<c:forEach items="${products}" var="e">
													<tr>
														...
														<td><img src="./Img/${e.getImageName()}"></td>
														<td><a href="deleteProduct?did=${e.getProductId()}"
															class="btn btn-danger">Delete</a></td>
														<td><a href="editProduct?uid=${e.getProductId()}"
