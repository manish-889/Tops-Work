		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="row">
						<c:forEach items="${orders}" var="dt">
							<div class="col-lg-12 grid-margin stretch-card">
								<div class="card">
									<div class="card-body">
										<h4 class="card-title">${dt.getUser().getUserName()}</h4>
										<p class="card-description">
											Phone Number
											<code>${dt.getUser().getPhoneNumber()}</code>
										</p>
										<div class="table-responsive">
											<table class="table table-striped">
												...
												<tbody>
													<c:forEach items="${dt.getOrderItems()}" var="e">
														<tr>
															<td>${e.getOrderItemId()}</td>
															<td>${e.getProduct().getProductName()}</td>
															<td>${e.getProduct().getPrice()}</td>
															<td><img src="./Img/${e.getProduct().getImageName()}"></td>
															<td>${e.getProductQuantity()}</td>
															<td>${e.getProductQuantity() * e.getProduct().getPrice()}</td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
